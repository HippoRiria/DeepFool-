...
mnist=datasets.MNIST(
    root='D:/毕设/DeepFool/data/mnist/',train=True,transform=img_transform,download=True)
...
# 保存模型
torch.save(G.state_dict(), './img/generator.pth')
torch.save(D.state_dict(), './img/discriminator.pth')